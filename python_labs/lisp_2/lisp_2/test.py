...
# # def list_from_ll(ll):
# #     print('BAAB', lab.evaluate(lab.parse(lab.tokenize("(cons)"))))
# #     if isinstance(ll, lab.Pair):
# #         if ll.cdr == empty_rep:
# #             return [list_from_ll(ll.car)]
# #         return [list_from_ll(ll.car)] + list_from_ll(ll.cdr)
...
# #         if ll.cdr == empty_rep:
# #             return [list_from_ll(ll.car)]
# #         # print('Final;', [list_from_ll(ll.car)] + list_from_ll(ll.cdr))
# #         return [list_from_ll(ll.car)] + list_from_ll(ll.cdr)
# #     elif ll == empty_rep:
# #         return []
# #     elif isinstance(ll, (float, int)):
...
#                     typecheck = (int, float)
#                     func = lambda x: x if isinstance(x, typecheck) else "SOMETHING"
#                 print('in:', out['output'], 'out:', func(out["output"]))
#                 out["output"] = func(out["output"])
#             print('yaaa')
