...
def est_bacon_number_b():
    n=1
    expected = set([2876,1532])
    first_result = lab.actors_with_bacon_number(db_tiny, n)
    assert isinstance(first_result, set)
    assert first_result == expected
def est_bacon_number_c():
    n=2
    expected = set([1640])
    first_result = lab.actors_with_bacon_number(db_tiny, n)
    assert isinstance(first_result, set)
    assert first_result == expected
def test_bacon_number_d():
    n=3
    expected = set()
    first_result = lab.actors_with_bacon_number(db_tiny, n)
    assert isinstance(first_result, set)
...
def test_bacon_path_00():
    actor_id = 1640
    expected = [4724, 2876, 1640]

    first_result = lab.bacon_path(db_tiny, actor_id)
    assert first_result == expected
...
def test_actor_to_actor_path_00():
    # Actor path, large database, length of 5 (6 actors, 5 movies)
    actor_1 = 1395629
    actor_2 = 58566
    len_expected = 5
